...
public class Practice4 {
    ...
    public static void dataCollect(String[] data) {
        ...
        LinkedList[] linkedList = new LinkedList[set.size()]; // 이부분이 중요
        for (int i = 0; i < linkedList.length; i++) { // linkedList를 돌면서 각각의
                                                    //arr[i]를 넣어줘야 linkedList에 접근 가능
